...
pipeline_url = "https://raw.githubusercontent.com/IIabdullah97/Abdullah-Hassan/main/G1000vectorizer.pkl"
model_url = "https://raw.githubusercontent.com/IIabdullah97/Abdullah-Hassan/main/G1000model.pkl"
...
try:
    ...
    pipeline_path = download_file(pipeline_url, "G1000vectorizer.pkl")
    model_path = download_file(model_url, "G1000model.pkl")
